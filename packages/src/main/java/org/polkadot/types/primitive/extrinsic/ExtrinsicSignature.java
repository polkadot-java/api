...
public class ExtrinsicSignature extends Struct implements Types.IExtrinsicSignature {
    ...
    public ExtrinsicSignature addSignature(Object _signer, byte[] _signature, Object _nonce, byte[] _era) {
    ...
    public ExtrinsicSignature sign(Call method, KeyringPair account, Types.SignatureOptions signatureOptions) {
