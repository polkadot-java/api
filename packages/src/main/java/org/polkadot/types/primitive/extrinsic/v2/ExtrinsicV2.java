...
import org.polkadot.types.primitive.extrinsic.v1.ExtrinsicSignatureV1;
 ...
 */
public class ExtrinsicV2 extends Struct implements IExtrinsicImpl {

    public static final int TRANSACTION_VERSION = 2;

    public static class ExtrinsicValueV2 {
        Call method;
        ExtrinsicSignatureV2 signature;

        public ExtrinsicValueV2(Call method, ExtrinsicSignatureV2 signature) {
            this.method = method;
    ...
    public ExtrinsicV2(Object value, ExtrinsicOptions options) {
        super(new Types.ConstructorDef()
                        .add("signature", ExtrinsicSignatureV2.class)
    ...
    static Object decodeExtrinsic(Object value, ExtrinsicOptions options) {
        if (value instanceof ExtrinsicV2) {
            ...
            return new ExtrinsicValueV2((Call) value, null);
        } else if (Utils.isU8a(value)) {
            // here we decode manually since we need to pull through the version information
            ExtrinsicSignatureV2 signature = new ExtrinsicSignatureV2(value, new ExtrinsicSignatureOptions(options.isSigned));

            Call method = (Call) CreateType.createType("Call",
                    ArrayUtils.subarray((byte[]) value, signature.getEncodedLength(), ((byte[]) value).length)
            );
            return new ExtrinsicValueV2(method, signature);
        }
    ...
    @Override
    public ExtrinsicV2 addSignature(Object signer, byte[] signature, Object nonce, byte[] era) {
    ...
    @Override
    public ExtrinsicV2 sign(KeyringPair account, Types.SignatureOptions options) {
