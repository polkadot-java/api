...
public class ListenAndUnsubToBlocks {
    ...
    //
    //    AtomicReference<IRpcFunction.E04_Unsubscribe> unsubscribe = new AtomicReference<>();
    //
    //    ready.then(api -> {
    //        IRpcFunction subscribeNewHead = api.rpc().chain().function("subscribeNewHead");
    //        Promise<IRpcFunction.E04_Unsubscribe<Promise>> invoke = subscribeNewHead.invoke(
    ...
    //                });
    //        return invoke;
    //    }).then((IRpcFunction.E04_Unsubscribe<Promise> result) -> {
